    ...
    <div className="reply">
      ...
      <div className="comment__content">
        ...
        <p className="comment__text">
          سلام . از اینکه در چنین رویداد با این سطح از تجربه و دانش افراد شرکت کردم راضی هستم :) پذیرایی عالی بود و حرف
          نداشت .امیدوارم سال بعد بهتر و پرقدرت از امسال باز هم برگذار بشه . دکتر آوند بعنوان ارائه کننده اطلاعات بسیار
          جامع و مفیدی ارائه و انتقال دادن. در کل حرف نداشت 👌
        </p>
      </div>
    </div>
  );
